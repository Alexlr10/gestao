# Generated by Django 2.0 on 2020-05-06 14:49
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('despesa', models.CharField(choices=[('ICMS', 'ICMS'), ('SN', 'Simples-Nacional'), ('GAS', 'Gasolina'), ('SER', 'Serviços'), ('INSS', 'INSS')], max_length=4, verbose_name='Despesa')),
                ('data', models.DateField(blank=True, null=True, verbose_name='data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipoReuniao', models.CharField(choices=[('GER', 'GERAL'), ('DIR', 'DIRETORIA')], max_length=4, verbose_name='Reunião')),
